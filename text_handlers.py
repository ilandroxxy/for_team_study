...
class ForUser():
    ...
    @staticmethod
    def push_trash(self):
        answer = ('Что тут вообще происходит?', 'Что здесь происходит?', 'Что тут происходит?',
                  'Что тут вообще творится?', 'Что здесь вообще происходит?', 'Что здесь творится?',
                  'Что тут вообще творится?', 'Что здесь происходит?', 'Что тут происходит?',
